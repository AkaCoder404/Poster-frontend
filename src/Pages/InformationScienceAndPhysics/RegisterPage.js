...
function RegisterPage() {
    ...
    const handleSubmitForm = async () => {
        ...
        await axios.post('/api/upload-phys/', formData).then((response) => {
            ...
            setSubmitLoading(false);
            navigate("/poster-info-phys/success?uuid=" + uuid);
        }).catch((error) => {
            setSubmitLoading(false);
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <Option value="1">Robotics Science and System</Option>
                                <Option value="2">Signal Processing</Option>
                                <Option value="3">Theoretical Computer Science</Option>
                                <Option value="4">Graphics and Geometric Computing</Option>
                                <Option value="5">Biophotonics</Option>
                                <Option value="6">Cryptography and Information Security</Option>
